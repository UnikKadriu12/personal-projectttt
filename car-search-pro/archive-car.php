...
<main class="site-content">
    <section class="section-heading">
        <h2><?php _e('Cars for Rent', 'car-search-pro'); ?></h2>
        <p><?php _e('Browse all available car rentals and choose the perfect vehicle for your trip.', 'car-search-pro'); ?></p>
    </section>
    ...
    <?php else : ?>
        <p><?php _e('No car rentals are available at the moment. Please check back soon.', 'car-search-pro'); ?></p>
    <?php endif; ?>
</main>
